...
//    @Override
//    public List<Issue> findAllIssuesByTemplateId(Long templateId) {
//        return ConvertUtils.convertToFindAllIssuesResponseList(repositoryService.findAllIssuesByTemplateId(templateId)
//                .stream()
//                .sorted(Comparator.comparing(IssueEntity::getName))
//                .collect(Collectors.toList()));
//    }
