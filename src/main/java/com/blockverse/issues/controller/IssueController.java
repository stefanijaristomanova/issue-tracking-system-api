...
//    @ApiOperation(value = "Find a issue by templateId", response = ResponseEntity.class)
//    @ApiResponses(value = {
//            @ApiResponse(code = 200, message = "Issue successfully found"),
//            @ApiResponse(code = 404, message = "The issue you were trying to retrieve was not found")
//    })
...
//    @ResponseBody
//    public List<Issue> findAllIssuesByTemplateId(@RequestParam Long templateId) throws Exception {
//        return issueService.findAllIssuesByTemplateId(templateId);
//    }
...
//    @ApiOperation(value = "Find next history for an issue by the tag id", response = ResponseEntity.class)
//    @ApiResponses(value = {
//            @ApiResponse(code = 200, message = "Next history successfully found"),
//            @ApiResponse(code = 500, message = "Internal server error while fetching the next in history")
//    })
//    @GetMapping(value = "/next-version/{templateID}", produces = MediaType.APPLICATION_JSON_VALUE)
//    @ResponseBody
//    public ResponseEntity<Integer> findNextVersion(@PathVariable("templateID") Long templateID) {
//        return ResponseEntity.ok(issueService.findNextVersion(templateID));
//    }
